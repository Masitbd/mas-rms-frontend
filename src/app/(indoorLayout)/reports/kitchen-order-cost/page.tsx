...
import { KitchenOrderCostTable } from "@/components/reports/KitchenOrderCostTable";
import { useGetBranchQuery } from "@/redux/api/branch/branch.api";
import { useLazyGetKitchenOrdersCostQuery } from "@/redux/api/report/report.api";
import { formatDate } from "@/utils/formateDate";
import { useSession } from "next-auth/react";

const KitchenOrderCostPage: FC = () => {
  ...
  // Lazy query to fetch kitchen order costs
  const [
    getReport,
  ...
  const isDataPresent = !!reportData;
  ...
  return (
    <ReportTemplate
      ...
      onClear={handleClear}
      header="Kitchen Order Cost Report"
      subHeader="Track and analyze total and item-wise costs of kitchen orders by date range and branch"
      dataComponent={
        <KitchenOrderCostTable
...
export default KitchenOrderCostPage;
