...
const WaiterWiseSalesPage = () => {
  ...
  const { data, isLoading } = useGetWaiterWiseSalesReportsQuery(queryParams, {
    skip: !isSearchEnable,
  });
...
export default WaiterWiseSalesPage;
