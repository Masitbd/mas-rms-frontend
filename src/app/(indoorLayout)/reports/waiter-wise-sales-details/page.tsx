...
import { useLazyGetWaiterWiseSaleStatementReportsQuery } from "@/redux/api/report/report.api";
import { formatDate } from "@/utils/formateDate";
import { useSession } from "next-auth/react";

const WaiterWiseSalesDetailsPage: FC = () => {
  ...
  // Lazy query to fetch waiter wise sales statement report
  const [
    getReport,
  ...
  return (
    <ReportTemplate
      ...
      onClear={handleClear}
      header="Waiter Wise Sales Statement Details"
      subHeader="Analyze sales details and category breakdown by waiter and branch"
      dataComponent={
