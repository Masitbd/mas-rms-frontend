...
import { useLazyGetItemWiseRawMaterialsConsumptionReportsQuery } from "@/redux/api/report/report.api";
import { formatDate } from "@/utils/formateDate";
import { useSession } from "next-auth/react";

const ItemWiseRawMatConsumpPage: FC = () => {
  ...
  // Lazy query to fetch item wise raw material consumption report
  const [
    getReport,
  ...
  return (
    <ReportTemplate
      ...
      onClear={handleClear}
      header="Item Wise Raw Materials Consumption"
      subHeader="Analyze raw material consumption broken down by finished menu items"
      dataComponent={
        <ItemWiseRawConTable
...
export default ItemWiseRawMatConsumpPage;
