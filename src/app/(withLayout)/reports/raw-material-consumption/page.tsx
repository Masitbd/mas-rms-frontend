...
import { useGetRawMaterialsConsumptionReportsQuery } from "@/redux/api/report/report.api";
import { useState } from "react";
import { IFormValues } from "../daily-sales-report/page";
import { formatDate } from "@/utils/formateDate";
import RawmaterialsConsupmtionTable from "@/components/reports/RawmaterialsConsupmtionTable";
import { Button, DatePicker, Form } from "rsuite";

const RawMaterialsConsumptionPage = () => {
const [isSearchEnable, setIsSearchEnable] = useState(false);
  ...
  const { data, isLoading } = useGetRawMaterialsConsumptionReportsQuery(queryParams, {
    skip: !isSearchEnable,
  });
